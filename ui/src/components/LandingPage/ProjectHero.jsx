  ...
  return (
    <div data-aos='fade-left' className={`font-roboto relative pl-10 pr-10 pt-5 pb-5 mt-10 flex gap-x-[2rem] justify-center flex-col md:flex-row md:justify-between`}>
        ...
        <div className='p-5 md:mb-0 mb-[1rem]'>
            <h1 className={`font-cursive text-4xl sm:text-6xl text-white font-bold tracking-wider`}>8+ Niches</h1>
            <div className='w-fit text-black text-4xl sm:text-6xl mt-3 font-bold tracking-wider'>
                <h1 className={`font-cursive bg-gradient-to-tr from-[#ec1183] to-[#7e257f] text-transparent bg-clip-text`}>30+ Projects</h1>
            </div>
            <p className='mt-4 text-[#FFFFFF4F] text-lg font-bold w-[100%] md:w-[70%] tracking-widest'>A powerful ecosystem with a diversified range of projects to bridge technology and usability</p>
        </div>
